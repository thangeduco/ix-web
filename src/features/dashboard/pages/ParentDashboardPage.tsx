...
export function ParentDashboardPage() {
  ...
  return (
    <div className="parentdashboard-page ix-page">
      <PageHeader
        eyebrow="Dashboard"
        title="Dashboard phụ huynh"
        subtitle="Theo dõi kết quả, việc cần làm và xếp hạng của con."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="parentdashboard-page__hero">
        <Card>
          <div className="parentdashboard-page__hero-content">
            <div>
              <p className="parentdashboard-page__lead">
              ...
              <div className="parentdashboard-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="parentdashboard-page__actions">
      ...
      <div className="parentdashboard-page__content">
        <Card>
          <div className="parentdashboard-page__section-head">
        ...
        <Card>
          ...
          <ul className="parentdashboard-page__notes">
