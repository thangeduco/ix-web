...
export function RankingRegionPage() {
  const featureApi = featureApiMap['ranking']
  const metrics = rankingMock.metrics
  const table = rankingMock.table

  return (
    <div className="rankingregion-page ix-page">
      <PageHeader
        eyebrow="Ranking"
        title="Bảng xếp hạng khu vực"
        subtitle="Theo dõi phân bố điểm và vị trí trong khu vực."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="rankingregion-page__hero">
        <Card>
          <div className="rankingregion-page__hero-content">
            <div>
              <p className="rankingregion-page__lead">
              ...
              <div className="rankingregion-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="rankingregion-page__actions">
      ...
      <div className="rankingregion-page__content">
        <Card>
          <div className="rankingregion-page__section-head">
        ...
        <Card>
          ...
          <ul className="rankingregion-page__notes">
