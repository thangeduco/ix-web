...
export function PauseSuccessPage() {
  const featureApi = featureApiMap['submission']
  const metrics = submissionMock.metrics
  const table = submissionMock.table

  return (
    <div className="pausesuccess-page ix-page">
      <PageHeader
        eyebrow="Submission"
        title="Đã tạm dừng bài làm"
        subtitle="Trạng thái làm bài được lưu để tiếp tục sau."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="pausesuccess-page__hero">
        <Card>
          <div className="pausesuccess-page__hero-content">
            <div>
              <p className="pausesuccess-page__lead">
              ...
              <div className="pausesuccess-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="pausesuccess-page__actions">
      ...
      <div className="pausesuccess-page__content">
        <Card>
          <div className="pausesuccess-page__section-head">
        ...
        <Card>
          ...
          <ul className="pausesuccess-page__notes">
