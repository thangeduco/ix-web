import './HomeworkViewSubmittedPage.css'
...
export function HomeworkViewSubmittedPage() {
  const featureApi = featureApiMap['submission']
  const metrics = submissionMock.metrics
  const table = submissionMock.table

  return (
    <div className="homeworkviewsubmitted-page ix-page">
      <PageHeader
        eyebrow="Submission"
        title="Bài làm đã nộp"
        subtitle="Xem lại ảnh bài làm đã gửi lên hệ thống."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="homeworkviewsubmitted-page__hero">
        <Card>
          <div className="homeworkviewsubmitted-page__hero-content">
            <div>
              <p className="homeworkviewsubmitted-page__lead">
              ...
              <div className="homeworkviewsubmitted-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="homeworkviewsubmitted-page__actions">
      ...
      <div className="homeworkviewsubmitted-page__content">
        <Card>
          <div className="homeworkviewsubmitted-page__section-head">
        ...
        <Card>
          ...
          <ul className="homeworkviewsubmitted-page__notes">
