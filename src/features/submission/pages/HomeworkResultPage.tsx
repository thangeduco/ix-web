...
export function HomeworkResultPage() {
  ...
  return (
    <div className="homeworkresult-page ix-page">
      <PageHeader
        eyebrow="Submission"
        title="Kết quả bài tập"
        subtitle="Xem điểm và nhận xét cho bài tập tự luận."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="homeworkresult-page__hero">
        <Card>
          <div className="homeworkresult-page__hero-content">
            <div>
              <p className="homeworkresult-page__lead">
              ...
              <div className="homeworkresult-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="homeworkresult-page__actions">
      ...
      <div className="homeworkresult-page__content">
        <Card>
          <div className="homeworkresult-page__section-head">
        ...
        <Card>
          ...
          <ul className="homeworkresult-page__notes">
