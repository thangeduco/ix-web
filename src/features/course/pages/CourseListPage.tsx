...
export function CourseListPage() {
  ...
  return (
    <div className="courselist-page ix-page">
      <PageHeader
        eyebrow="Course"
        title="Danh sách khóa học"
        subtitle="Khám phá các khóa học theo môn, khối và mục tiêu."
        actions={{
          primary: 'Tải dữ liệu',
          secondary: 'Xem API',
        }}
      ...
      <div className="courselist-page__hero">
        <Card>
          <div className="courselist-page__hero-content">
            <div>
              <p className="courselist-page__lead">
              ...
              <div className="courselist-page__api">
                <span>API chính:</span>
                <code>{featureApi.primary}</code>
              </div>
            </div>
            <div className="courselist-page__actions">
      ...
      <div className="courselist-page__content">
        <Card>
          <div className="courselist-page__section-head">
        ...
        <Card>
          ...
          <ul className="courselist-page__notes">
